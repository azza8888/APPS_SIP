package com.ezatech.apps_sip.Utils;
...
public class GpsTracker extends Service implements LocationListener {
    ...
    private void showAlertDialog() {
        alertDialogManager.showAlertDialog(GpsTracker.this, "GPS Setting", "Gps is not enabled. Do you want to enabled it ?",false);
    }
